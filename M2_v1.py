...
for i in range(len(list)-1):
    lines = line[0].split(".")
    return_code = subprocess.Popen('C:\module2\DownloadFile-main\PsExec.exe' + ' -s \\' + list[i] + ' -u ' + lines[1] + '\\' + lines[0] + ' -p ' + lines[3] + '-c C:\module2\GetCredential\Credential_output.txt')
f.close()
